...
func (s *MicroAppService) GetAppInfo(ctx context.Context, componentAppID, componentAccessToken string) (
	*AppInfo, *http.Response, error) {
	u := fmt.Sprintf("v1/microapp/app/info?component_app_id=%v&component_access_token=%v",
...
func (s *MicroAppService) DownloadQrcode(ctx context.Context, componentAppID, componentAccessToken string,
	body *DownloadQrcodeRequest) (*http.Response, error) {
	u := fmt.Sprintf("v1/microapp/app/qrcode?component_app_id=%v&component_access_token=%v",
...
func (s *MicroAppService) CheckAppName(ctx context.Context, componentAppID, componentAccessToken, appName string) (*http.Response, error) {
	u := fmt.Sprintf("v1/microapp/app/check_app_name?component_app_id=%v&component_access_token=%v&app_name=%v",
		componentAccessToken, componentAppID, appName)
...
func (s *MicroAppService) ModifyAppName(ctx context.Context, componentAppID, componentAccessToken string,
	body *ModifyAppNameRequest) (*http.Response, error) {
	u := fmt.Sprintf("v1/microapp/app/modify_app_name?component_app_id=%v&component_access_token=%v",
		componentAccessToken, componentAppID)
...
// ModifyIntro 修改小程序简介
func (s *MicroAppService) ModifyIntro(ctx context.Context, componentAppID, componentAccessToken string,
	body *ModifyAppIntroRequest) (*http.Response, error) {
	u := fmt.Sprintf("v1/microapp/app/modify_app_intro?component_app_id=%v&component_access_token=%v",
		componentAccessToken, componentAppID)
...
func (s *MicroAppService) ModifyAppIcon(ctx context.Context, componentAppID, componentAccessToken string,
...
func (s *MicroAppService) ModifyServerDomain(ctx context.Context, componentAppID, componentAccessToken string,
	body *ModifyServerDomainRequest) (*http.Response, error) {
	u := fmt.Sprintf("v1/microapp/app/modify_server_domain?component_app_id=%v&component_access_token=%v",
		componentAccessToken, componentAppID)
...
func (s *MicroAppService) ModifyWebviewDomain(ctx context.Context, componentAppID, componentAccessToken string,
	body *ModifyWebviewDomainRequest) (*http.Response, error) {
	u := fmt.Sprintf("v1/microapp/app/modify_webview_domain?component_app_id=%v&component_access_token=%v",
		componentAccessToken, componentAppID)
